...
export default function DashboardLayout({
  ...
  // If no user and no gate cookie, show login prompt.
  // But if the site gate is active, the user is a guest — skip this screen.
  if (!user) {
    return (
        ...
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-sm text-muted-foreground text-center max-w-sm">
              Sign in to access production scheduling, inventory management, and velocity tracking.
            </p>
          </div>
          <Button
            onClick={() => {
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                ...
                >
                  ...
                  <span>{user?.openId === "guest" ? "Exit" : "Sign out"}</span>
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </SidebarFooter>
